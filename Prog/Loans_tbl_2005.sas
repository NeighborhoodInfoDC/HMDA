...
data Loans_tbl (compress=no);
  ...
  set Hmda.Loans_&year (keep=ulender geo2000 ucounty loantype action subprime_lender high_interest purpose amount lien rtspread);
...
proc tabulate data=Loans_tbl format=comma10. noseps missing;
  ***where geo2000 =: "11" and loantype = "1" and action = "1";
  ...
  title3 "Home Mortgage Loans, Washington, DC, &year";
...
proc tabulate data=Loans_tbl format=comma10. noseps missing;
  ***where geo2000 =: "11" and loantype = "1" and action = "1" and subprime_lender;
  ...
  title3 "Subprime Home Mortgage Lending, Washington, DC, &year";
