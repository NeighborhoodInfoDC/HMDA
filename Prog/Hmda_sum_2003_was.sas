/**************************************************************************
 ...
 Description:  Copy HMDA 2003 tract summary file from Dataplace Alpha
 directory to DCData HMDA library.
 
 Modifications:
  08/24/06  New name for source file: Dplex_hmda_summary_03a
**************************************************************************/
...
data Hmda_sum_&year._was;
  ...
  set dplace.Dplex_hmda_summary_03a;
